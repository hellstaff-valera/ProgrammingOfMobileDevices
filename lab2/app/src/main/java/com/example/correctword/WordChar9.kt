...
import com.example.correctword.databinding.FragmentWordChar9Binding

class WordChar9 : Fragment() {
    private lateinit var binding: FragmentWordChar9Binding
    private val dateModel: DateModel by activityViewModels()
    private var wordTrue = arrayOfNulls<String>(9)
    private var arrayWord = arrayOfNulls<String>(9)
    private var arrayTextView = arrayOfNulls<TextView>(9)
    private var arrayTextViewTrue = arrayOfNulls<TextView>(9)
    ...
    override fun onCreateView(
        ...
        binding = FragmentWordChar9Binding.inflate(inflater)
        return binding.root
    }
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        arrayTextViewTrue = arrayOf(
            ...
            binding.textCharTrue7,
            binding.textCharTrue8,
            binding.textCharTrue9
        )
        ...
        binding.textChar7.setOnClickListener {
            val letter = binding.textChar7.text
            binding.textChar7.text = "-"
            if (letter != "-")
                fillArray(arrayTextViewTrue, letter)
        }
        binding.textChar8.setOnClickListener {
            val letter = binding.textChar8.text
            binding.textChar8.text = "-"
            if (letter != "-")
                fillArray(arrayTextViewTrue, letter)
        }
        binding.textChar9.setOnClickListener {
            val letter = binding.textChar9.text
            binding.textChar9.text = "-"
            if (letter != "-")
                fillArray(arrayTextViewTrue, letter)
        }
        ...
        binding.textCharTrue7.setOnClickListener {
            val letter = binding.textCharTrue7.text
            binding.textCharTrue7.text = "-"
            if (letter != "-")
                fillArray(arrayTextView, letter)
        }
        binding.textCharTrue8.setOnClickListener {
            val letter = binding.textCharTrue8.text
            binding.textCharTrue8.text = "-"
            if (letter != "-")
                fillArray(arrayTextView, letter)
        }
        binding.textCharTrue9.setOnClickListener {
            val letter = binding.textCharTrue9.text
            binding.textCharTrue9.text = "-"
            if (letter != "-")
                fillArray(arrayTextView, letter)
        }
        onStart()
    ...
    companion object {
        fun newInstance() = WordChar9().apply { Bundle().apply {} }
    }
    ...
    private fun fillArray(arrayTextTrue: Array<TextView?>, letter: CharSequence) {
        ...
        if (winWord(arrayTextTrue) && counter == 8) {
            counterTrueWord++
    ...
    private fun wordToTextView() {
        ...
        Word().wordChar9[number].forEachIndexed { index, char ->
            arrayWord[index] = char.toString()
        }
        Word().wordChar9[number].forEachIndexed { index, char -> wordTrue[index] = char.toString() }
        arrayWord.shuffle()
